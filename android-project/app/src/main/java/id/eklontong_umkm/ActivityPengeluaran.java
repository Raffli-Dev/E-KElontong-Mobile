...
public class ActivityPengeluaran extends AppCompatActivity {
    ...
    public static void navigate(Context activity, String id) {
        Intent i = new Intent(activity.getApplicationContext(), ActivityPengeluaran.class);
        i.putExtra("OBJ", id);
    ...
    private AdapterPengeluaran adapter;
    private RelativeLayout lyt_tanggal;
    ...
    private void initComponent() {
        ...
        adapter = new AdapterPengeluaran(getApplicationContext(), recycler_view, Constant.NEWS_EVENT_PAGE);
        recycler_view.setAdapter(adapter);
        et_tanggal = (EditText) findViewById(R.id.et_tanggal);
        button_filter = (ImageButton) findViewById(R.id.button_filter);
        lyt_tanggal = (RelativeLayout) findViewById(R.id.lyt_tanggal);

        // detect when scroll reach bottom
        adapter.setListener(new AdapterListener<Pengeluaran>(){
            @Override
            public void onClick(View view, String type, Pengeluaran obj, int position) {
...
//                    ((ActivityMain) getActivity()).showInterstitialAd();
        ...
        lyt_tanggal.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        et_tanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                showDateCreatedAt();
                Toast.makeText(getApplicationContext(), "sssd", Toast.LENGTH_LONG).show();
            }
        });
        ...
        lyt_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ActivityPengeluaran.this, ActivityPengeluaranCreate.class);
...
//            swipeProgress(true);
    ...
    private void requestNewsEvent(final Integer page_no) {
        ...
        params.date = et_tanggal.getText().toString();
        new Request(this).pengeluaranList(params, new RequestListener<RespPengeluaran>() {
            @Override
    ...
    private void showDateCreatedAt() {
        ...
        materialDatePicker.addOnPositiveButtonClickListener(new MaterialPickerOnPositiveButtonClickListener() {
            ...
            public void onPositiveButtonClick(Object selection) {
                et_tanggal.setText(materialDatePicker.getHeaderText());
