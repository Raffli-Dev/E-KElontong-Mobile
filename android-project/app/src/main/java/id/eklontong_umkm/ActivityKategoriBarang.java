...
public class ActivityKategoriBarang extends AppCompatActivity {
    public static void navigate(Context activity, String id) {
        Intent i = new Intent(activity.getApplicationContext(), ActivityKategoriBarang.class);
        i.putExtra("OBJ", id);
    ...
    private AdapterKategoriBarang adapter;
    ...
    private void initComponent() {
        ...
        adapter = new AdapterKategoriBarang(getApplicationContext(), recycler_view, Constant.NEWS_EVENT_PAGE);
        recycler_view.setAdapter(adapter);
        button_filter = (ImageButton) findViewById(R.id.button_filter);

        // detect when scroll reach bottom
        adapter.setListener(new AdapterListener<KategoriBarang>(){
            @Override
            public void onClick(View view, String type, KategoriBarang obj, int position) {
...
//                    ((ActivityMain) getActivity()).showInterstitialAd();
        ...
        lyt_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ActivityKategoriBarang.this, ActivityKategoriBarangCreate.class);
...
//            swipeProgress(true);
    ...
    private void requestNewsEvent(final Integer page_no) {
        ...
        new Request(this).kategoriBarangList(params, new RequestListener<RespKategoriBarang>() {
            @Override
    ...
    private void displayApiResult(final List<KategoriBarang> items) {
