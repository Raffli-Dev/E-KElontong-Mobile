...
public class AdapterShoppingCartSalesRetur extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<CartReturSales> items;
    private Boolean is_cart = true;

    private AdapterListener<CartReturSales> listener;

    public void setListener(AdapterListener<CartReturSales> listener) {
    ...
    public AdapterShoppingCartSalesRetur(Context ctx, boolean is_cart, List<CartReturSales> items) {
        this.ctx = ctx;
        this.items = items;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (is_cart) {
            if (holder instanceof ViewHolder) {
                ...
                final CartReturSales c = items.get(position);
...
//                Toast.makeText(ctx, "Price Item " + c.price_item, Toast.LENGTH_LONG).show();
                ...
                vItem.lyt_parent.setOnClickListener(v -> {
                    ...
                    listener.onClick(v, ActionType.ITEM.name(), c, position);
                });
    ...
    public List<CartReturSales> getItem() {
        return items;
    }
    ...
    public void setItems(List<CartReturSales> items) {
        this.items = items;
