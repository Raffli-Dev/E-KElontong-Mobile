...
public class AdapterPengeluaranLabaRugi extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AdapterPengeluaranLabaRugi(Context context, RecyclerView view, int page) {
        this.ctx = context;
        this.page = page;
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        public TextView title, txt_tanggal, total_price;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_pengeluaran_laba_rugi_row, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            v.title.setText(pengeluaran.expense_for);
            v.total_price.setText(pengeluaran.expense_amt);
