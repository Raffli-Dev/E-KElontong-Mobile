...
public class DialogUtils {
    ...
    public Dialog buildDialogInfo(String title, String content, String bt_text_pos, @DrawableRes int icon, final CallbackDialog callback) {
        return buildDialogInfo(title, content, bt_text_pos, "", icon, callback);
    }

    // dialog info
    public Dialog buildDialogInfo(String title, String content, String bt_text_pos, String bt_text_neg, @DrawableRes int icon, final CallbackDialog callback) {
        ...
        Button bt_positive = dialog.findViewById(R.id.bt_positive);
        Button bt_negative = dialog.findViewById(R.id.bt_negative);
        bt_positive.setText(bt_text_pos);
        bt_negative.setText(bt_text_neg);
        if(bt_text_neg.equals("")){
