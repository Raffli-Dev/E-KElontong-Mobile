...
<body onload="window.print();"><!--   -->
    ...
    $sales_invoice_footer_text=$res4->sales_invoice_footer_text;
  	...
  	$q3=$this->db->query("SELECT a.sales_due,a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.payment_status,
                           b.created_by, b.biaya_pajak,b.biaya_pajak_total
    ...
    $biaya_pajak=$res3->biaya_pajak;
    $biaya_pajak_total=$res3->biaya_pajak_total;
    ...
    $countBiayaPajak = $this->db->query("select * from db_tax where id = '$biaya_pajak'")->num_rows();
    $tax_name = "";
    $tax_value = "";
    if($countBiayaPajak > 0) {
        $biayaPajak = $this->db->query("select * from db_tax where id = '$biaya_pajak'")->row();
        $tax_name = $biayaPajak->tax_name;
        $tax_value = $biayaPajak->tax;
    }
			...
			<td align="left">
                <table width="100%" align="center">
                    <tr>
                        ...
                        <td align="left" width="50%">
                            <span>
                                <strong>Pacitan, <?= $sales_date; ?><br>
                                    Kepada Yth:<br>
                                    <?= strtoupper($customer_name); ?><br>
                                    <?= strtoupper($customer_address); ?><br>
			...
			<td>
				<table width="100%">
					<tr>
						...
						<td><b>#<?= $sales_code; ?></b> | <?= strtoupper($seller_name) ?></td>
					</tr>
					<tr>
			...
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						<?php
			              ...
			              foreach ($q2->result() as $res2) {
			                  ...
			                  echo "<td style='padding-left: 2px; padding-right: 2px;'>".number_format($res2->price_per_unit, 2)."</td>";
			                  echo "<td style='text-align: center;padding-left: 2px; padding-right: 2px;'>".number_format($res2->sales_qty)."</td>";
					...
					<!-- <tr><td style="border-bottom-style: dashed;border-width: 0.1px;" colspan="5"></td></tr>   -->
                     <tr>
                         <td style=" padding-left: 2px; padding-right: 2px;font-weight: bold;" colspan="5" align="right">Pajak (<?= $tax_name; ?>)</td>
                         <td style=" padding-left: 2px; padding-right: 2px;font-weight: bold;" align="right"><?php echo number_format($biaya_pajak_total, 0); ?></td>
                     </tr>

					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;font-weight: bold;" colspan="5" align="right"><?= $this->lang->line('total'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px;font-weight: bold;" align="right"><?= number_format($grand_total, 2); ?></td>
					</tr>
