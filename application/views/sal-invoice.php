...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $q3=$this->db->query("SELECT a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.payment_status,b.pos,b.biaya_pajak,b.biaya_pajak_total
                 ...
                 <div class="form-group">
                    ...
                    <table  class="col-md-11">
                       ...
                       <tr>
                        ...
                        <tr>
                            <th class="text-right" style="font-size: 17px;">Pajak (<?= $tax_name; ?>)</th>
                            <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                <h4><b id="biaya_pajak_total" name="biaya_pajak_total"><?=$biaya_pajak_total;?></b></h4>
                            </th>
                        </tr>
                       <tr>
