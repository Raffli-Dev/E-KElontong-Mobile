...
<?php
    ...
    $q3=$this->db->query("SELECT a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.payment_status,b.biaya_pajak,b.biaya_pajak_total
...
<tfoot>
  ...
  <tr>
      <td colspan="9" style="text-align: right;"><b>Pajak (<?= $tax_name; ?>)</b></td>
      <td colspan="1" style="text-align: right;" ><b><?php echo number_format($biaya_pajak_total, 0); ?></b></td>
  </tr>
  <tr>
...
<?php
      ...
      echo "<span class='amt-in-word'>Terbilang: <i style='font-weight:bold;'>".NumberToWords(round($grand_total))."</i></span>";
