...
<tfoot>
  ...
  <tr>
      <td colspan="14" class='text-right'><b>Pajak (<?= $tax_name; ?>)</b></td>
      <td colspan="2" class='text-right' ><b><?php echo number_format($biaya_pajak_total, 0); ?></b></td>
  </tr
...
<?php
      ...
      echo "<span class='amt-in-word'>Terbilang: <i style='font-weight:bold;'>".$currency_code." ".NumberToWords($grand_total)."</i></span>";
