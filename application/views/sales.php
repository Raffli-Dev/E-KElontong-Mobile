                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                  <div class="row">
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="" class="col-sm-4 control-label">Pajak</label>
                                              <div class="col-sm-8">
                                                  <select class="form-control " id="biaya_pajak" name="biaya_pajak" onchange="final_total();" style="width: 100%;">
                                                      <?php
                                                      $q1="select * from db_tax where status=1";
                                                      $q1=$this->db->query($q1);
                                                      if($q1->num_rows()>0)
                                                      {
                                                          echo "<option value='0' data-tax='0.00'>None</option>";
                                                          foreach($q1->result() as $res1)
                                                          {
                                       ...
                                       <div class="form-group">
                                          ...
                                          <table  class="col-md-9">
                                             ...
                                             <tr style="<?= (!is_enabled_round_off()) ? 'display: none;' : '';?>">
                                              ...
                                              <tr>
                                                  <th class="text-right" style="font-size: 17px;"><span class="label_biaya_pajak">Pajak</span> </th>
                                                  <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                      <h4><b id="biaya_pajak_total" name="biaya_pajak_total">0.00</b></h4>
                                                  </th>
                                              </tr>
                                             <tr>
        ...
        /*function set_to_original(i,purchase_price) {
         ...
         function final_total(){
          ...
          if($("#other_charges_input").val()!=null && $("#other_charges_input").val()!=''){
           ...
           var biaya_pajak_percent=0;
           var total_biaya_pajak_percent=0;
           ...
           if((subtotal!=null || subtotal!='') && (subtotal!=0)){
            ...
            // if($("#discount_to_all_input").val()!=null && $("#discount_to_all_input").val()!=''){
             ...
             //subtotal_round=Math.round(taxable);
               biaya_pajak =$('option:selected', '#biaya_pajak').attr('data-tax');
               biaya_pajak_percent = biaya_pajak / 100;
               total_biaya_pajak_percent = taxable * biaya_pajak_percent;
               $(".label_biaya_pajak").text("Pajak "+biaya_pajak+" % ");
               $("#biaya_pajak_total").html(total_biaya_pajak_percent.toFixed(2));

             subtotal_round=round_off(taxable + total_biaya_pajak_percent);//round_off() method custom defined
