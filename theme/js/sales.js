...
$('#save,#update').on("click",function (e) {
  var this_id=this.id;
   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    var biaya_pajak_total=$("#biaya_pajak_total").text();
        ...
        $("#"+this_id).attr('disabled',true);  //Enable Save or Update button
				$.ajax({
				type: 'POST',
				url: base_url+'sales/sales_save_and_update?command='+this_id+'&rowcount='+rowcount+'&tot_subtotal_amt='+tot_subtotal_amt+'&tot_discount_to_all_amt='+tot_discount_to_all_amt+'&tot_round_off_amt='+tot_round_off_amt+'&tot_total_amt='+tot_total_amt+"&other_charges_amt="+other_charges_amt+"&biaya_pajak_total="+biaya_pajak_total,
				data: data,
				cache: false,
				contentType: false,
				processData: false,
